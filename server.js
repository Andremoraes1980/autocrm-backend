...
console.log("🔐 SUPABASE_SERVICE_ROLE_KEY (primeiros 20):", process.env.SUPABASE_SERVICE_ROLE_KEY?.substring(0, 20));
console.log("🔒 SUPABASE_SERVICE_ROLE_KEY (últimos 20):", process.env.SUPABASE_SERVICE_ROLE_KEY?.slice(-20));
